  ...
  return (
    <div className="fixed inset-0 z-[100]">
      ...
      >
        <div
          ref={containerRef}
          className="relative max-w-lg w-full sm:w-[460px] bg-white rounded-2xl sm:rounded-3xl shadow-2xl overflow-y-auto lg:overflow-hidden animate-[fadeIn_0.25s_ease-out] max-h-[88vh] sm:max-h-none"
          role="dialog"
          aria-modal="true"
        ...
        >
          ...
          <div
            className="relative p-5 sm:p-6 lg:p-8 animate-modal-slide"
          ...
          >
            ...
            <div className="max-w-md mx-auto flex flex-col justify-start sm:justify-center pt-2 sm:pt-0">
              <div className="text-center sm:text-left mb-3 sm:mb-5">
                <h1 className="text-base sm:text-lg lg:text-3xl font-bold text-slate-900 mb-2 sm:mb-3">
              ...
              {/* Toggle Buttons */}
              <div className="flex bg-slate-100 rounded-xl p-1 mb-4 sm:mb-5">
                <button
              ...
              <div className="mt-5 sm:mt-6 text-center text-sm">
                ...
                <button
                  onClick={() => { setIsLogin(!isLogin); setErrors({}); setFormError(''); }}
